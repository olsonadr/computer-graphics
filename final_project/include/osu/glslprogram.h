...
class GLSLProgram {
    ...
    public:
        ...
        GLSLProgram();
        GLSLProgram(int n, int *attrib_idx, const char **attrib_names);
        ~GLSLProgram();
        ...
        void SetUniformVariable4(const char *, float[4]);
        void SetUniformVariableMat4(const char *, float[16]);
        void SetUniformVariable(const char *, glm::vec3);
        void SetUniformVariable(const char *, glm::vec4);
        // void SetUniformVariable4(const char [], float[4]);
    #ifdef VEC3_H
